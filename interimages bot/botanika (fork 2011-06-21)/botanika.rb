...
ex = ['Botanicy', 'Organizacje botaniczne', 'Dokumenty i publikacje botaniczne', 'Leśnicy'].sort
...
if File.exist? 'list-marshal'
	...
	list = (s.make_list 'category-r', 'Kategoria:Leśnictwo') + (s.make_list 'category-r', 'Kategoria:Botanika')
	exclude = ex.map{|e| s.make_list 'category-r', 'Kategoria:'+e}.flatten
